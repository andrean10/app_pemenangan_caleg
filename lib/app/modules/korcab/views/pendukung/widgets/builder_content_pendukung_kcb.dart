...
class BuilderContentPendukungKcb extends GetView<PendukungKcbController> {
  const BuilderContentPendukungKcb({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    Widget builderInfo(DataPendukung item) {
    ...
    return LiquidPullToRefresh(
      ...
      child: PagedListView<int, DataPendukung>.separated(
