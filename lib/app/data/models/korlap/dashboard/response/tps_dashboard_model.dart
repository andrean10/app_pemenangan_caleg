...
class TpsDashboardModel {
  ...
  factory TpsDashboardModel.fromJson(Map<String, dynamic> json) =>
      TpsDashboardModel(
        id: json['id'] as int?,
        ...
        villages: json['villages'] == null
            ? null
            : VillagesModel.fromJson(json['villages'] as Map<String, dynamic>),
      );
