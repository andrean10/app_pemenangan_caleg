import 'villages_header_model.dart';

class TpsHeaderModel {
  int? id;
  int? provincesId;
  int? regenciesId;
  int? districtsId;
  ...
  factory TpsHeaderModel.fromJson(Map<String, dynamic> json) => TpsHeaderModel(
        ...
        villages: json['villages'] == null
            ? null
            : VillagesHeaderModel.fromJson(
                json['villages'] as Map<String, dynamic>),
      );
